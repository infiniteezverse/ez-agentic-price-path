...
- **MCP server** — `npx mcp-ezpath` · listed at registry.modelcontextprotocol.io
- **elizaOS plugin** — `pnpm add plugin-ezpath`
- **CDP AgentKit** — PR open at coinbase/agentkit
- **Agentverse** — registered proxy agent on @fetch_ai
...
Chain ID `8453` · USDC `0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913` · Toll `0x13dDE704389b1118B20d2BCc6D3Ace749600e2ad`

First agent-to-agent transaction confirmed on-chain. Claude called EZ-Path autonomously, signed the payment, received the best quote — zero human intervention.

Built on @base · Integrated with @fetch_ai · Plugin for @elizaOS · Compatible with @virtuals_io agent stack

---

*EZ-Path · ezpath.myezverse.xyz · contact@ezsecuretech.com*
