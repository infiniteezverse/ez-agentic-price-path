...
// After the bot has written its first snapshot, commit
// agents/zen-usdc-trader/state/history.json to GitHub and paste the raw URL here.
// Example: https://raw.githubusercontent.com/<owner>/<repo>/main/agents/zen-usdc-trader/state/history.json
...
export const LINKS = {
  ...
  github: 'https://github.com/infiniteezvers/ez-path',
